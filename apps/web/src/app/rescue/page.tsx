    ...
    <div style={{ minHeight: "100vh", background: "#0a1a0e", color: "#E8F5E9", fontFamily: "var(--font-sans), sans-serif", paddingBottom: "80px" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
          <Link href="/dashboard" style={{ color: "rgba(232,245,233,0.55)", textDecoration: "none", display: "flex", alignItems: "center", gap: "6px", fontSize: "0.875rem" }}>
        ...
        {loading ? (
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: "1.1rem", fontWeight: 700, margin: "0 0 8px 0" }}>
              {hasNoLocation ? "Set your location to see cases" : `No Active Cases in Your ${scope === "area" ? "Area" : scope === "city" ? "City" : "State"}`}
            </h3>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "4px" }}>
              ...
              <span style={{
                ...
                {scope === "area" ? "📍 Area" : scope === "city" ? "🏙 City" : "🗺 State"} scope
              </span>
            </div>
